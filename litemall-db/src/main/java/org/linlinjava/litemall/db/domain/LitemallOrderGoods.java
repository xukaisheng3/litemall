...
public class LitemallOrderGoods {
    ...
    public Integer getDoorstoreId() {
        return doorstoreId;
    }

    public void setDoorstoreId(Integer doorstoreId) {
        this.doorstoreId = doorstoreId;
    }
    ...
    public String toString() {
        ...
        sb.append(", doorstoreId=").append(doorstoreId);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getDoorstoreId() == null ? other.getDoorstoreId() == null : this.getDoorstoreId().equals(other.getDoorstoreId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDoorstoreId() == null) ? 0 : getDoorstoreId().hashCode());
    ...
    public enum Column {
        ...
        doorstoreId("doorstore_id", "doorstoreId", "INTEGER", false),
